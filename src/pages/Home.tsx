    ...
    <Layout>
      ...
      */}
      <ScrollAnimatedSection
        id="about"
        className="py-20 bg-bg-card border-y border-border-main"
      >
      ...
      */}
      ...
      {/* 
        ...
        ========================================================================
      */}
      <section id="journey" className="py-20 bg-bg-base">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimatedSection>
      ...
      */}
      ...
      <ScrollAnimatedSection id="contact" className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-primary mb-6">// PROTOCOLAR CONTATO?</h2>
