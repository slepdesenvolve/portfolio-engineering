/**
 * @file App.tsx
 * @description Componente principal do portfólio.
 * Estrutura em React + Tailwind CSS + Framer Motion.
 */
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bg-base bg-grid selection:bg-secondary/50 text-text-main">
      {/* 
        ========================================================================
        1. NAVEGAÇÃO (HEADER)
        ========================================================================
        ...
        >
          <div>
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-primary mb-6 leading-tight">
              |Codificando Lógica;{" "}
              <span className="text-primary text-glow italic block">
                _Arquitetando Realidade;
              </span>
            </h1>
            <div className="text-lg md:text-xl text-text-muted max-w-2xl mb-10 leading-relaxed">
              ...
              <p className="mt-4">
                Arquiteto de sistemas focado em escalabilidade e lógica backend.
                Transformo caos de dados em estruturas modulares. Minha
                prioridade é performance de código e automação inteligente. O
                visual é consequência da função.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#projects"
                className="px-8 py-4 bg-secondary hover:brightness-110 text-white font-bold rounded-lg transition-all shadow-lg shadow-secondary/30 flex items-center justify-center gap-3 group"
              >
                <RuneIcon
                  type="wand"
                  className="w-5 h-5 text-accent group-hover:scale-125 group-hover:rotate-12 transition-all duration-300"
                />
                Iniciar Exploração
              </a>
              <a
                href="#about"
                className="px-8 py-4 border border-secondary/50 hover:border-primary text-text-muted hover:text-primary font-bold rounded-lg transition-all flex items-center justify-center gap-3 group"
              >
                <RuneIcon
                  type="eye"
                  className="w-5 h-5 text-primary group-hover:scale-110 transition-all duration-300"
                />
                Ver Stats
              </a>
            </div>
      ...
      */}
      <ScrollAnimatedSection
        id="about"
        className="py-20 bg-bg-card/50 border-y border-border-main"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl font-bold text-primary mb-6 underline decoration-secondary decoration-4 underline-offset-8">
                // LOG DO SISTEMA: ORIGEM
              </h2>
              <div className="space-y-4 text-text-muted leading-relaxed">
                ...
                <div>
                  Minha build foi forjada na intersecção entre a complexidade do
                  chão de fábrica e a precisão da camada de gestão.
                  <p className="mt-2">
                    Não acredito em sorte (RNG), acredito em determinismo: dados
                    íntegros e bem estruturados geram decisões estratégicas
                    infalíveis.
                  </p>
                </div>
                <div>
                  Minha missão principal (Main Quest) é a erradicação de
                  ineficiências operacionais através de automação inteligente e
                  arquitetura de dados.
                  <p className="mt-2">
                    Onde houver um gargalo sistêmico ou uma tarefa repetitiva
                    consumindo recursos, eu projeto a lógica que os elimina.
                  </p>
                </div>
                <div className="grid grid-cols-2 gap-4 mt-8">
                  <div className="p-4 rounded-lg bg-bg-base border border-border-main group hover:border-primary/50 transition-colors">
                    <span className="block text-primary font-bold text-2xl mb-1">
                      Class:{" "}
                    </span>
                  ...
                  <div className="p-4 rounded-lg bg-bg-base border border-border-main group hover:border-primary/50 transition-colors">
                    <span className="block text-secondary font-bold text-2xl mb-1">
                      Skill:{" "}
                    </span>
                    <span className="text-xs uppercase tracking-wider text-text-muted">
                      DATA MINING
      ...
      <ScrollAnimatedSection id="projects" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            ...
            <span className="block mt-4 text-xs uppercase text-text-main">
              Projetos selecionados que demonstram impacto e domínio técnico.
            </span>
          </div>
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.techs.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-bg-base text-secondary text-xs font-bold rounded border border-secondary/30"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    className="text-secondary hover:text-accent group-hover:scale-105 text-sm font-bold flex items-center gap-2 hover:gap-3 transition-all"
                  >
                    INSPECIONAR SCRIPT
                    <span>→</span>
                  </a>
      ...
      */}
            ...
            {SKILL_CATEGORIES.map((cat) => (
              ...
              >
                <div className="flex justify-between items-start mb-8">
                  <h3 className="text-primary font-bold text-lg leading-tight pr-4">
                    {cat.title}
                  </h3>
      ...
      {/* 
        ...
        ========================================================================
      */}
      <section id="journey" className="py-20 bg-bg-card/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimatedSection>
      ...
      {/* 
        ...
        ========================================================================
      */}
      <ScrollAnimatedSection id="contact" className="py-20 bg-secondary">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-primary mb-6">
            // PROTOCOLAR CONTATO?
          </h2>
          <p className="text-primary/80 mb-10 text-lg">
            Transformo gargalos operacionais em fluxos automatizados. Seja para
            projetos escaláveis ou consultoria técnica, estabeleça o uplink
            abaixo.
          </p>
          <a
            href="mailto:ricardonogueira.dev@gmail.com"
            className="inline-flex items-center gap-3 bg-accent text-bg-base px-10 py-5 rounded-full font-black text-xl hover:bg-primary hover:scale-105 transition-all shadow-2xl"
          >
            ENVIAR SINAL DE RÁDIO
      ...
      */}
      <footer className="py-12 bg-bg-base text-center border-t border-border-main">
        ...
        <p className="mono text-text-muted text-xs tracking-widest">
          ©2026 // RICARDO NOGUEIRA //{" "}
          <span className="text-secondary">
            TODOS_DIREITOS_NERDS_RESERVADOS
          </span>
        </p>
      </footer>
